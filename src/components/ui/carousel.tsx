  ...
  return (
    <div
      ...
      className={cn(
        ...
        orientation === "horizontal" ? "pl-41" : "pt-4",
        className,
      )}
      {...props}
    />
  ...
  (
    ...
    return (
      <Button
        ...
        size={size}
        className={cn(
          "absolute ml-1 flex h-8 w-8 cursor-pointer items-center justify-center rounded-lg border bg-gray-200 p-2 hover:bg-gray-100",
          orientation === "horizontal"
  ...
  (
    ...
    return (
      <Button
        ...
        className={cn(
          "absolute right-0 mr-1 flex h-8 w-8 cursor-pointer items-center justify-center rounded-lg border bg-gray-200 p-2 hover:bg-gray-100",
          orientation === "horizontal"
