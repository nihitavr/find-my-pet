export default function TermsAndConditions() {
  return (
    <main className="rounded-lg bg-white p-5 shadow-md md:flex-row md:gap-10 md:px-28 md:py-8">
      <h1 className="mb-5 text-4xl font-semibold md:text-5xl">
        Terms and Conditions
      </h1>
      <p className="mb-2 font-semibold">Last updated March 27, 2024</p>
      <h2 className="mb-2 mt-5 text-xl font-semibold">
        AGREEMENT TO OUR LEGAL TERMS
      </h2>
      <p className="mb-4">
        We are ANA Pet Essentials and Technology (referred to as &quot;Find My
        Pet&quot;, &quot;Company&quot;, &quot;we&quot;, &quot;us&quot;,
        &quot;our&quot;) , a company registered in India at{" "}
        <span className="font-semibold">
          ANA Pet Essentials and Technology, Flat no. A-004, Ground floor,
          Euphoria apartment, 2nd. main road. no. 14, Aswini layout, Ejipura,
          Koramangla, Bengaluru Urban, Karnataka - 560047 India
        </span>
      </p>
      <p className="mb-4">
        We operate the website{" "}
        <span className="font-semibold">findmypet.in</span> (the
      ...
      <p className="mb-4">
        ...
        <span className="font-semibold">+91-6363822930</span>, email at
        <span className="font-semibold"> findmypet.in@gmail.com</span>, or by
        mail to ANA Pet Essentials and Technology, Flat no. A-004, Ground floor,
        Euphoria apartment, 2nd. main road. no. 14, Aswini layout, Ejipura,
        Koramangla, Bengaluru Urban, Karnataka - 560047 India
      </p>
      <p className="mb-4">
        ...
        and FindMyPet, concerning your access to and use of the Services. You
      ...
      <p className="mb-4"></p>
      <h2 id="table" className="mb-2 text-xl font-semibold">
        Table of Contents
      </h2>
      <ol className="mb-4 list-decimal pl-6">
        <li className="mb-2">
          <a href="#our-services" className="text-blue-600 underline">
            OUR SERVICES
          </a>
        </li>
        <li className="mb-2">
        ...
        <li className="mb-2">
          <a href="#user-representations" className="text-blue-600 underline">
            USER REPRESENTATIONS
          </a>
        </li>
        <li className="mb-2">
          <a href="#user-registration" className="text-blue-600 underline">
            USER REGISTRATION
          </a>
        </li>
        <li className="mb-2">
        ...
        <li className="mb-2">
          <a href="#purchases-and-payment" className="text-blue-600 underline">
            PURCHASES AND PAYMENT
          </a>
        </li>
        <li className="mb-2">
          <a href="#return-refunds-policy" className="text-blue-600 underline">
            RETURN/REFUNDS POLICY
          </a>
        </li>
        <li className="mb-2">
          <a href="#prohibited-activities" className="text-blue-600 underline">
        ...
        <li className="mb-2">
          <a href="#contribution-license" className="text-blue-600 underline">
            CONTRIBUTION LICENSE
          </a>
        </li>
        <li className="mb-2">
          <a href="#social-media" className="text-blue-600 underline">
            SOCIAL MEDIA
          </a>
        </li>
        <li className="mb-2">
        ...
        <li className="mb-2">
          <a href="#services-management" className="text-blue-600 underline">
            SERVICES MANAGEMENT
          </a>
        </li>
        <li className="mb-2">
        ...
        <li className="mb-2">
          <a href="#term-and-termination" className="text-blue-600 underline">
        ...
        <li className="mb-2">
          <a href="#governing-law" className="text-blue-600 underline">
            GOVERNING LAW
          </a>
        </li>
        <li className="mb-2">
          <a href="#dispute-resolution" className="text-blue-600 underline">
            DISPUTE RESOLUTION
          </a>
        </li>
        <li className="mb-2">
          <a href="#corrections" className="text-blue-600 underline">
            CORRECTIONS
          </a>
        </li>
        <li className="mb-2">
        ...
        <li className="mb-2">
          <a href="#indemnification" className="text-blue-600 underline">
            INDEMNIFICATION
          </a>
        </li>
        <li className="mb-2">
          <a href="#user-data" className="text-blue-600 underline">
            USER DATA
          </a>
        </li>
        <li className="mb-2">
        ...
        <li className="mb-2">
          <a href="#miscellaneous" className="text-blue-600 underline">
            MISCELLANEOUS
          </a>
        </li>
        <li className="mb-2">
      ...
      <br />
      <h2 id="our-services" className="mb-2 text-xl font-semibold">
        1. OUR SERVICES
      </h2>
      <p className="mb-4">
      ...
      <h3 className="mb-2 text-lg font-semibold">Our intellectual property</h3>
      <p className="mb-4">
      ...
      <h3 className="mb-2 text-lg font-semibold">Your use of our Services</h3>
      <p className="mb-4">
      ...
      <ol className="mb-4 list-disc pl-6">
      ...
      <p className="mb-4">
        ...
        address your request to: findmypet.in@gmail.com. If we ever grant you
      ...
      <p className="mb-4">
        <span className="font-semibold">Copyright infringement:</span> We
        ...
        <a href="#copyright-infringements" className="text-blue-600 underline">
          COPYRIGHT INFRINGEMENTS
        </a>{" "}
        section below.
      </p>
      ...
      <br />
      <h2 id="user-representations" className="mb-2 text-xl font-semibold">
      ...
      <br />
      <h2 id="user-registration" className="mb-2 text-xl font-semibold">
        4. USER REGISTRATION
      </h2>
      <p className="mb-4">
      ...
      <br />
      <h2 id="products" className="mb-2 text-xl font-semibold">
        5. PRODUCTS
      </h2>
      <p className="mb-4">
      ...
      <br />
      <h2 id="purchases-and-payment" className="mb-2 text-xl font-semibold">
        6. PURCHASES AND PAYMENT
      </h2>
      <p className="mb-4">We accept the following forms of payment:</p>
      <ol className="mb-4 list-disc pl-6">
        <li className="mb-2">Visa</li>
        <li className="mb-2">Mastercard</li>
      </ol>
      <p className="mb-4">
      ...
      <br />
      <h2 id="return-refunds-policy" className="mb-2 text-xl font-semibold">
      ...
      <br />
      <h2 id="prohibited-activities" className="mb-2 text-xl font-semibold">
      ...
      <br />
      <h2 id="contribution-license" className="mb-2 text-xl font-semibold">
      ...
      <br />
      <h2 id="social-media" className="mb-2 text-xl font-semibold">
        11. SOCIAL MEDIA
      </h2>
      <p className="mb-4">
      ...
      <br />
      <h2 id="services-management" className="mb-2 text-xl font-semibold">
      ...
      <br />
      <h2 id="privacy-policy" className="mb-2 text-xl font-semibold">
        14. PRIVACY POLICY
      </h2>
      <p className="mb-4">
        ...
        hosted in India . If you access the Services from any other region of
      ...
      <br />
      <h2 id="copyright-infringements" className="mb-2 text-xl font-semibold">
      ...
      <br />
      <h2 id="term-and-termination" className="mb-2 text-xl font-semibold">
      ...
      <br />
      <h2 id="governing-law" className="mb-2 text-xl font-semibold">
        18. GOVERNING LAW
      </h2>
      <p className="mb-4">
        These Legal Terms shall be governed by and defined following the laws of
        India . FindMyPet and yourself irrevocably consent that the courts of
        India shall have exclusive jurisdiction to resolve any dispute which may
        arise in connection with these Legal Terms.
      </p>

      <br />
      <h2 id="dispute-resolution" className="mb-2 text-xl font-semibold">
        19. DISPUTE RESOLUTION
      </h2>
      <h3 className="mb-2 text-lg font-semibold">Informal Negotiations</h3>
      <p className="mb-4">
      ...
      <h3 className="mb-2 text-lg font-semibold">Binding Arbitration</h3>
      <p className="mb-4">
        ...
        Bangalore, India . The language of the proceedings shall be English .
        The governing law of these Legal Terms shall be substantive law of India
        .
      </p>
      <h3 className="mb-2 text-lg font-semibold">Restrictions</h3>
      <p className="mb-4">
      ...
      <br />
      <h2 id="corrections" className="mb-2 text-xl font-semibold">
        20. CORRECTIONS
      </h2>
      <p className="mb-4">
      ...
      <br />
      <h2 id="disclaimer" className="mb-2 text-xl font-semibold">
        21. DISCLAIMER
      </h2>
      <p className="mb-4">
      ...
      <br />
      <h2 id="limitations-of-liability" className="mb-2 text-xl font-semibold">
      ...
      <br />
      <h2 id="indemnification" className="mb-2 text-xl font-semibold">
        23. INDEMNIFICATION
      </h2>
      <p className="mb-4">
      ...
      <br />
      <h2 id="user-data" className="mb-2 text-xl font-semibold">
        24. USER DATA
      </h2>
      <p className="mb-4">
      ...
      <br />
      <h2 id="miscellaneous" className="mb-2 text-xl font-semibold">
        26. MISCELLANEOUS
      </h2>
      <p className="mb-4">
      ...
      <br />
      <h2 id="contact-us" className="mb-2 text-xl font-semibold">
        27. CONTACT US
      </h2>
      <p className="mb-4">
      ...
      <p className="mb-4">
        <span className="font-semibold">
          ANA Pet Essentials and Technology,
        </span>{" "}
        <br /> Flat no. A-004, Ground floor, Euphoria apartment,
        <br /> 2nd. main road. no. 14, Aswini layout, Ejipura, <br />
        Koramangla, Bengaluru Urban, <br />
      ...
      <ol className="mb-4 list-disc pl-6">
        <li className="mb-2">
          <a href="#data-access" className="text-blue-600 underline"></a>
        </li>
      </ol>
      <ol className="mb-4 list-decimal pl-6">
        <li className="mb-2">
